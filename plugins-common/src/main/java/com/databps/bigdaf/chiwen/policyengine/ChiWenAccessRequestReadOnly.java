...
public class ChiWenAccessRequestReadOnly implements ChiWenAccessRequest {
	private final ChiWenAccessRequest source;

	// Cached here for reducing access overhead
	private final ChiWenAccessResource resource;
	private final Set<String> userGroups;
	private final List<String> forwardedAddresses;
	private final Map<String, Object> context;

	public ChiWenAccessRequestReadOnly(final ChiWenAccessRequest source) {
		this.source = source;
	...
	@Override
	public ChiWenAccessResource getResource() { return resource; }
	...
	//@Override
	//public ChiWenAccessRequest getReadOnlyCopy() { return this; }
