...
import com.databps.bigdaf.chiwen.plugin.ChiWenHdfsAuthorizer;
 ...
 */
public class HDFSChiWenTest {

    private static final File baseDir = new File("/Users/merlin/Documents/packages/target/hdfs/").getAbsoluteFile();
    ...
    public static void setup() throws Exception {
        ...
        conf.set(MiniDFSCluster.HDFS_MINIDFS_BASEDIR, "/Users/merlin/Documents/eclipse-workspace/ideaProject/bigdaf/hdfs-agent/target");
        conf.set("dfs.namenode.inode.attributes.provider.class", ChiWenHdfsAuthorizer.class.getName());
    ...
    @org.junit.Test
    public void writeTestOne() throws Exception {
        ...
        UserGroupInformation ugi = UserGroupInformation.createUserForTesting("bob", new String[] {"ssss"});
        ...
        ugi.doAs(new PrivilegedExceptionAction<Void>() {
            ...
            public Void run() throws Exception {
                ...
                try {
                    ...
                    // expected
                    Assert.assertTrue(ChiWenAccessControlException.class.getName().equals(ex.getClassName()));
                }
