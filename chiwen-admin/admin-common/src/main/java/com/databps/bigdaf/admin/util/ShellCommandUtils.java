...
public class ShellCommandUtils {
	  private static final Logger LOG = LoggerFactory.getLogger(ShellCommandUtils.class);
	  ...
	  private static final String ADMIN_SUDO = "admin-sudo.sh";
	  ...
	  */
	   ...
	   * @param sudo          true to execute the command using sudo (admin-sudo); otherwise false
