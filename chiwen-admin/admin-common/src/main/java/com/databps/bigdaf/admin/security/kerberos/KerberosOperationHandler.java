...
//import org.apache.ambari.server.utils.ShellCommandUtils;
...
public abstract class KerberosOperationHandler {
  ...
  public abstract Integer produceKeytabFile(String principal, String filePath, boolean service)
      throws KerberosOperationException;
  ...
  protected ShellCommandUtils.Result executeCommand(String[] command, Map<String, String> envp, ShellCommandUtils.InteractiveHandler interactiveHandler)
      throws KerberosOperationException {
    ...
    if ((command == null) || (command.length == 0)) {
      ...
      try {
        return ShellCommandUtils.runCommand(command, envp, interactiveHandler, false);
      } catch (IOException e) {
  ...
  protected ShellCommandUtils.Result executeCommand(String[] command)
      throws KerberosOperationException {
    return executeCommand(command, null);
  }


  protected ShellCommandUtils.Result executeCommand(String[] command, ShellCommandUtils.InteractiveHandler interactiveHandler) throws KerberosOperationException {
