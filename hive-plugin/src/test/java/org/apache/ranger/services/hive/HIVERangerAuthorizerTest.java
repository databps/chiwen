...
public class HIVERangerAuthorizerTest {
    ...
    public static void setup() throws Exception {
      /*  // Get a random port
        ...
        conf.set(HiveConf.ConfVars.METASTORE_CONNECTION_USER_NAME.varname,"bob");
        conf.set(HiveConf.ConfVars.METASTOREPWD.varname, "bob");
...
//        }
        if (resultSet.next()) {
            System.out.println(resultSet.getString(1)+"aaaaaaaaaaaaaaaaaaaa");
        } else {
            System.out.println(resultSet.getString(1)+"No ResultSet found");
        }
        statement.close();
        connection.close();
        ...
        conf.set(HiveConf.ConfVars.HIVE_AUTHORIZATION_MANAGER.varname,
                 "com.databps.bigdaf.chiwen.plugin.ChiWenHiveAuthorizerFactory");*/
