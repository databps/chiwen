...
public class ChiWenHiveResource extends ChiWenAccessResourceImpl {
	...
	public ChiWenHiveResource(HiveObjectType objectType, String databaseorUrl) {
		this(objectType, databaseorUrl, null, null);
	}

	public ChiWenHiveResource(HiveObjectType objectType, String databaseorUrl, String tableOrUdf) {
		this(objectType, databaseorUrl, tableOrUdf, null);
	}
	
	public ChiWenHiveResource(HiveObjectType objectType, String databaseorUrl, String tableOrUdf, String column) {
