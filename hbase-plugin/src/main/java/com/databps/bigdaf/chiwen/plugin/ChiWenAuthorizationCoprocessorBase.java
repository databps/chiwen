...
/**
 * com.databps.bigdaf.chiwen.plugin.ChiWenAuthorizationCoprocessorBase
 *
 * @author lgc
 * @create 2017-08-28 下午3:33
 */
abstract public class ChiWenAuthorizationCoprocessorBase extends BaseRegionObserver
    implements MasterObserver, RegionServerObserver, BulkLoadObserver {

  private static final Log LOG = LogFactory
      .getLog(ChiWenAuthorizationCoprocessorBase.class.getName());
